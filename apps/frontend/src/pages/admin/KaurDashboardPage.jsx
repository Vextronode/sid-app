// ==========================================
// KaurDashboardPage.jsx
// Kaur TU Umum sekarang cuma monitoring + cetak surat yang sudah
...
export default function KaurDashboardPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto py-6">
      <h1 className="text-lg font-medium text-gray-700 mb-4">Kaur TU Umum</h1>
      ...
      <button
        onClick={() => navigate('/admin/list-kaur')}
