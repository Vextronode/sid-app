...
// ==========================================
// KadusListPage.jsx
// Desain identik RTListPage. Bedanya: kolom Aksi cuma tombol Lihat
// (tidak ada Edit/Hapus), dan modal yang terbuka selalu read-only.
// ==========================================
...
export default function KadusListPage() {
  ...
  return (
    <>
              ...
              paginatedData.map((s) => (
                <tr key={s.id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4">
                    {/* Cuma tombol Lihat, tidak ada Edit/Hapus */}
                    <button
      ...
      <SuratDetailModalKadus suratId={selectedId} onClose={() => setSelectedId(null)} />
    </>
  );
}