...
import { useSuratDetail } from '../hooks/useSuratDetailkadus';
...
export default function SuratDetailModalkadus({ suratId, onClose, onApprove, onReject, readOnly = false }) {
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-2xl relative max-h-[90vh] overflow-y-auto">
        ...
        {notFound ? (
          ...
          <>
            ...
            <ApprovalStepperkadus surat={surat} />
