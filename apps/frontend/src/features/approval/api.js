 ...
 * - kasi
 */
export const getSuratList = (role, params = {}) => api.get(`/api/${role}/letters`, { params })
 ...
 */
export const getSuratDetail = (id) => api.get(`/api/letters/${id}`)

/**
 * RT, Kades, dan Kasi menggunakan endpoint decision.
 *
 * status:
 * - approved
 * - rejected
...
/**
 * Hanya Kasi yang menggunakan endpoint approve.
 *
 * status:
 * - approved
 * - rejected
