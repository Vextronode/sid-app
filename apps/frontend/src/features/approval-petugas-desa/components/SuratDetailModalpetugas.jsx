// ==========================================
// SuratDetailModalpetugas.jsx
// ==========================================

import { useState } from 'react';
import { useSuratDetail } from '../hooks/useSuratDetailpetugas';
import ApprovalStepperpetugas from './ApprovalStepperpetugas';
import SuratInfoGridpetugas from './SuratInfoGridpetugas';
import ApprovalActionBarpetugas from './ApprovalActionBarpetugas';
import RejectReasonModalpetugas from './RejectReasonModalpetugas';

export default function SuratDetailModalpetugas({ suratId, onClose, onApprove, onReject, readOnly = false }) {
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-2xl relative max-h-[90vh] overflow-y-auto">
        ...
        {notFound ? (
          ...
          <>
            ...
            <ApprovalStepperpetugas surat={surat} />
            <SuratInfoGridpetugas surat={surat} />
